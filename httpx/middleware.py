...
Responder = typing.Callable[
    [AsyncRequest], typing.Coroutine[typing.Any, typing.Any, AsyncResponse]
]
...
class RedirectMiddleware(BaseMiddleware):
    ...
    async def __call__(
        ...
        response.next = functools.partial(self, next_request, get_response)
        return response
